...
NexT.utils = {
  ...
  initSidebarDimension: function() {
    ...
    if (siteOverviewWrap) siteOverviewWrap.style.maxHeight = sidebarWrapperHeight;
  ...
  updateSidebarPosition: function() {
    ...
    if (hasTOC) {
      ...
      var tocPanel = document.querySelector('.post-toc-wrap');
      if (tocTab) tocTab.classList.add('sidebar-nav-active');
      if (tocPanel) tocPanel.classList.add('sidebar-panel-active');
    } else {
    ...
    // Sidebar hidden by default; user opens via toggle.
  },
